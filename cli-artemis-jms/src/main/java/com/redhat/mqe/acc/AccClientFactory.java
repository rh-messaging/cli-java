...
public class AccClientFactory extends ClientFactory {
    private Logger LOG = LoggerFactory.getLogger(AccClientFactory.class);
    MessageFormatter messageFormatter = new AccCoreMessageFormatter();
    ClientOptionManager clientOptionManager = new AccClientOptionManager();
